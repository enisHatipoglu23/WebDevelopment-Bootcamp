...
public class BookingUI extends Layout {
    ...
    public BookingUI(Car selectedCar, String strt_date, String fnsh_date) {
        ...
        // test için
        this.fld_book_name.setText("enis");
        this.fld_book_idno.setText("232323");
        this.fld_book_mail.setText("enishatipoglu@gmail.com");
        this.fld_book_mpno.setText("0505050505");
        this.fld_book_prc.setText("aaaa");
        this.txta_book_note.setText("bbbb");
