...
public class AdminUI extends Layout {
    ...
    private void loadCarComponent() {
        ...
        this.car_menu.add("Yeni").addActionListener(e -> {
            CarUI carUI = new CarUI(new Car());
            carUI.addWindowListener(new WindowAdapter() {
                @Override
                public void windowClosed(WindowEvent e) {
                    loadCarTable();
                }
        ...
        this.car_menu.add("Güncelle").addActionListener(e -> {
            ...
            CarUI carUI = new CarUI(this.carManager.getById(selectModelId));
            carUI.addWindowListener(new WindowAdapter() {
                @Override
                public void windowClosed(WindowEvent e) {
                    loadCarTable();
    ...
    private void loadModelComponent() {
        ...
        this.model_menu.add("Yeni").addActionListener(e -> {
            ModelUI modelUI = new ModelUI(new Model());
            modelUI.addWindowListener(new WindowAdapter() {
                @Override
                public void windowClosed(WindowEvent e) {
                    loadModelTable(null);
                }
        ...
        this.model_menu.add("Güncelle").addActionListener(e -> {
            ...
            ModelUI modelUI = new ModelUI(this.modelManager.getById(selectModelId));
            modelUI.addWindowListener(new WindowAdapter() {
                @Override
                public void windowClosed(WindowEvent e) {
                    loadModelTable(null);
    ...
    public void loadBrandComponent() {
        ...
        this.brand_menu.add("Yeni").addActionListener(e -> {
            BrandUI brandView = new BrandUI(null);
        ...
        this.brand_menu.add("Güncelle").addActionListener(e -> {
            ...
            BrandUI brandView = new BrandUI(this.brandManager.getById(selectBrandId));
            brandView.addWindowListener(new WindowAdapter() {
                @Override
                public void windowClosed(WindowEvent e) {
                    loadBrandTable();
